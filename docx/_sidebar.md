- [WinUi++](/)
  ...
  - [动作](./actions/README.md)
    ...
    - Web
      ...
      - [元素属性](./actions/web/WebElementAttribute.md)
      - [等待*警告框](./actions/web/WebWaitAlert.md)
      - [等待*呈现](./actions/web/WebWaitPresence.md)
      - [等待*内联框架可用](./actions/web/WebWaitFrameAvailable.md)
      - [等待*标题](./actions/web/WebWaitTitle.md)
      - [等待*元素可见](./actions/web/WebWaitVisibilityByElement.md)
      - [等待*元素可见（通过定位器）](./actions/web/WebWaitVisibilityByLocator.md)
      - [切换内联框架](./actions/web/WebSwitchToFrame.md)
      - [重设焦点](./actions/web/WebFocusFrameDefault.md)
      ...
      - [动作链*按键按下](./actions/web/WebActionKeyDown.md)
      - [动作链*按键松开](./actions/web/WebActionKeyUp.md)
      - [动作链*移动鼠标](./actions/web/WebActionMoveOffset.md)
      - [动作链*设置文本](./actions/web/WebActionSendText.md)
