- [WinUi++](/)
  ...
  - [动作](./actions/README.md)
    ...
    - 图像检测
      ...
      - [快速直线检测](./actions/detection/FastLineDetection.md)
    ...
    - 绘图
      - [标记对象](./actions/drawing/DrawDetectResults.md)
    - 深度学习
    ...
    - 算法
      ...
      - [索引*数组](./actions/algorithm/AccessArray.md)
      - [名称*对象](./actions/algorithm/AccessKey.md)
      - [长度*数组](./actions/algorithm/AccessSize.md)
      - [中心坐标](./actions/algorithm/CalculateCenter.md)
      - [坐标转换](./actions/algorithm/PointConvert.md)
      - [过滤文本](./actions/algorithm/FilterText.md)
      - [面积过滤](./actions/algorithm/FilterArea.md)
      - [FilterPerimeter](./actions/algorithm/FilterPerimeter.md)
      - [轮廓形状过滤](./actions/algorithm/FilterVertex.md)
