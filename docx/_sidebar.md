- [WinUi++](/)
  ...
  - [动作](./actions/README.md)
    ...
    - Web
      ...
      - [获取元素](./actions/web/WebGetElement.md)
      ...
      - [创建动作链](./actions/web/WebActionChainsCreated.md)
      - [执行动作链](./actions/web/WebActionChainsPerform.md)
      - [点击*动作链](./actions/web/WebActionClick.md)
